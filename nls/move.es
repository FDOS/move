...
0.8:          No pide confirmación para sobreescribir un fichero
...
0.12:          Verifica cada fichero según se escribe en el destino para
0.13:             asegurarse de que los ficheros de destino so idénticos
...
1.5:Parámetro no válido
1.6:Unidad origen no válida
1.7:Fichero destino no válido
1.8: no existe como directorio. ¿Crearlo?
1.9:Fichero origen no válido
...
1.18:Falta un parámetro requerido
1.19:Especificación de fuente no válida
1.20:No se encuentra la ruta origen
1.21:Ruta origen demasiado larga\n
1.22:Ruta de destino demasiado larga\n
1.23:Unidad de Especificación de unidad de destino no válida\n
